...
<template>
  <main>
    ...
    <div class="search-field">
      <QInput v-model="text" label="Wyszukaj miasto" label-color="#736b6b" color="#736b6b" filled
        class="bg-white text-black rounded-field" borderless @focus="focusOnInput = !focusOnInput"
    ...
    <div v-if="!focusOnInput" class="main-text">
      <span>Sprawdź zasoby wody w Twoim mieście i dowiedz się jak możesz oszczędzać
        wodę</span>
    </div>
